...
from .views import JobSeekerRegisterView, CompanyRepRegisterView, CustomTokenObtainPairView, JobSeekerProfileView, JobSeekerAvatarUpdateView, JobSeekerResumeUploadView
...
urlpatterns = [
    ...
    path("profile/resume/", JobSeekerResumeUploadView.as_view(), name="jobseeker-resume"),
]
