      ...
      <div className="applications-page">
        ...
        <div className="applications-content">
          <Box sx={{ mb: 3 }}>
            ...
            <Typography variant="body1" color="text.secondary">Your job applications in one place.</Typography>
          </Box>
          ...
          <Box sx={{ mt: 3 }}>
            <RouterLink to="/jobseeker/dashboard">← Back to dashboard</RouterLink>
          </Box>
        </div>
      </div>
    </ThemeProvider>
